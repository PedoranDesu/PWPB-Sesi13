package com.pedoran.pwpbsesi13.QRCodeLibrary;
...
public class ZxingLibraryExample extends AppCompatActivity {
    ImageView imageView;
    Button button;
    EditText editText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zxing_library_example);
